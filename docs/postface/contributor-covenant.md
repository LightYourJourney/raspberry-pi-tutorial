...
> #### ⚖️ 不以规矩，不能成方圆 {#rules}
>
> 本项目采用 [贡献者公约 2.0](https://www.contributor-covenant.org/version/2/0/code_of_conduct/) 指导行为准则 —— 明确社区价值观，致力于为每个人创造热情和安全的环境
...
如遇滥用、骚扰等不当行为，请通过 yanjinli502@gmail.com 向纪律检查委员举报。纪委将迅速审议并调查全部投诉。

社区全体负责人有义务保密举报者信息。

## 指导方针 {#enforcement-guidelines}
